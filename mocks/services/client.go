...
func (_m *Client) Balance(_a0 context.Context, _a1 *types.AccountIdentifier, _a2 *types.PartialBlockIdentifier) (*types.AccountBalanceResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.AccountIdentifier, *types.PartialBlockIdentifier) (*types.AccountBalanceResponse, error)); ok {
...
func (_m *Client) GetMempool(ctx context.Context) (*types.MempoolResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*types.MempoolResponse, error)); ok {
		return rf(ctx)
	}
...
func (_m *Client) Transaction(_a0 context.Context, _a1 *types.BlockIdentifier, _a2 *types.TransactionIdentifier) (*types.Transaction, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.BlockIdentifier, *types.TransactionIdentifier) (*types.Transaction, error)); ok {
		return rf(_a0, _a1, _a2)
	}
